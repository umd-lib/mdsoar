...
public class Params extends AbstractWingElement implements StructuralElement {
    ...
    public static final String[] PRESENTATIONS = { PRESENTATION_SELECT, PRESENTATION_SUGGEST, PRESENTATION_LOOKUP,
            PRESENTATION_NONE, PRESENTATION_AUTHORLOOKUP };
    ...
    /**
     * Enable the add operation for this field set. When this is enabled the front
     * end will add a button to add more items to the field.
     *
    ...
    /**
     * Enable the delete operation for this field set. When this is enabled then the
     * front end will provide a way for the user to select fields (probably
     ...
     *
     * @param size (Required) The size of the field.
     */
    ...
    /**
     * Set the event behavior (e.g. a javascript event) of the field.
     *
     * This applies to select fields as of this writing.
     *
     * @param behavior The action on onchange of the field.
     */
     ...
     *
     * @param maxlength (Required) The maximum length of the field.
     */
     ...
     *
     * @param rows (Required) The number of rows.
     */
     ...
     * The applies only to textarea fields.
     *
     * @param cols (Required) The number of columns.
     */
     ...
     *
     * @param returnValue (Required) The value to be returned if this field is
     *                    checked.
     */
     ...
     *
     * @param multiple (Required) whether the field can accept multiple values.
     */
     ...
     * required parameter.
     *
     * @param value Determine if the authority control is required or not on this
     *              field.
     */
    ...
    /**
     * Set the field's autofocus attribute, an HTML5 feature. Valid input values to
     * enable autofocus are: autofocus, and empty string.
     * 
    ...
    /**
     * Set the kind of UI presentation requested for this choice, e.g. select vs.
     * suggest. Value must match one of the PRESENTATIONS.
     *
    ...
    /**
     * Translate this element and all contained elements into SAX events. The events
     * should be routed to the contentHandler found in the WingContext.
     *
     * @param contentHandler (Required) The registered contentHandler where SAX
     *                       events should be routed too.
     * @param lexicalHandler (Required) The registered lexicalHandler where lexical
     *                       events (such as CDATA, DTD, etc) should be routed too.
     * @param namespaces     (Required) SAX Helper class to keep track of namespaces
     *                       able to determine the correct prefix for a given
     *                       namespace URI.
     * @throws org.xml.sax.SAXException passed through.
     */
    @Override
    public void toSAX(ContentHandler contentHandler, LexicalHandler lexicalHandler, NamespaceSupport namespaces)
            throws SAXException {
