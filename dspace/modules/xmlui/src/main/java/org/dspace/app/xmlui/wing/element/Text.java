...
public class Text extends Field {
     ...
     *
     * @param name    (Required) a non-unique local identifier used to differentiate
     ...
     *                to the server.
     * @param rend    (May be null) a rendering hint used to override the default
     *                display of the element.
     * @throws org.dspace.app.xmlui.wing.WingException passed through.
     */
    protected Text(WingContext context, String name, String rend) throws WingException {
     ...
     *
     * @param size (May be zero for no defined value) he default size for a field.
     */
     ...
     *
     * @param size      (May be zero for no defined value) he default size for a
     *                  field.
     * @param maxLength (May be zero for no defined value) The maximum length that
     *                  the theme should accept for form input.
     */
    ...
    /**
     * Enable the delete operation for this field. When this is enabled then the
     ...
     * Set the raw value of the field removing any previous raw values.
     *
     * @param characters (May be null) Field value as a string
     * @throws org.dspace.app.xmlui.wing.WingException passed through.
     */
     ...
     * Set the raw value of the field removing any previous raw values.
     *
     * @param message (Required) A key into the i18n catalogue for translation into
